...
class Contact extends React.Component {
  render() {
    ...
    return (
      <div className="container-fluid form-section" id="contact">
        <h1 className="py-3 section-heading-contact-bg pe-3 ">
          <span className="section-heading-contact">Contact Me</span>
        </h1>
        <Fade>
            ...
            <div className="d-flex justify-content-between">
              <form onSubmit={sendEmail} className="myForm">
                <div className="contact-left">
                  ...
                  <input
                    type={"submit"}
                    className="btn text-white rounded fw-bold contactBtn"
                    value={"Send"}
                  />
                </div>
              </form>
              <div className="contact-right mt-5">
                <p className="m-0 ">
                  Please feel free to write a feedback or contact me if you have
                  questions about me or my work .{" "}
                </p>
              </div>
            </div>
          </div>
