  ...
  render() {
      ...
      return (
        <SwiperSlide key={el.id}>
          <div className="project-card-left">
            ...
            <p className="card-left-text">{el.description ? el.description : "Under Construction..."}</p>
          </div>
    ...
    return (
      <div className="container-fluid projectsContainer p-0" id="projects">
        <h1 className="py-3 m-0 section-heading-projects-bg pe-3 "><span className="section-heading-projects">Projects</span></h1>
